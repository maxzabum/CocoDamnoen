            ...
            <div className="item-container landing-ourstory">
                <div className='top-grid'>
                    ...
                    <div className='text-right'>
                        ...
                        <div>
                            <div className='circle-container'>
                                <img src={BagSVG}
                                     style={screenWidth > 768 ? {width: 43.36, height: 59.78} : {
                                         width: 33.36,
                                         height: 49.78
                                     }}
                                     alt="img"/>
                        ...
                        <div>
                            <div className='circle-container'>
                                <img src={CoconutPNG}
                                     style={screenWidth > 768 ? {width: 44.55, height: 60} : {width: 39.55, height: 55}}
                                     alt="img"/>
                            </div>
                            <p>DELICIOUS</p>
                        </div>
                ...
                <div className='bottom-grid'>
                    ...
                    <div item xs={12} sm={6} className='text-right'>
                        ...
                        <button onClick={() => history.push('/ourstory')}>SEE OUR STORY</button>
                    </div>
                </div>
            </div>
